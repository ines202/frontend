    ...
    <div className="bg-purple-100">
      ...
      <header className="flex items-center justify-between p-8 shadow-md">
        <div className="flex items-center">
          <div className="relative h-20 w-20 p-2 drop-shadow-2xl">
            <Image
        ...
        <nav>
          ...
          <li>
              <Link href="#what-we-do" className="text-2xl font-bold text-black hover:text-purple-700"
                passHref>About Us
        ...
        <section className="flex flex-col items-center md:flex-row">
          <div className="ml-10 mt-10 md:w-1/2">
            ...
            <p className="mt-4 font-bold text-black">
              <span className="ml-4">Diabetic foot ulcers</span> (DFUs) are a
              ...
              amputations. So, we propose a comprehensive system which is our
